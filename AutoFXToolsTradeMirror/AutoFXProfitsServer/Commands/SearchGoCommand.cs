...
{
    public class SearchGoCommand : ICommand
    {
        ...
        public SearchGoCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            this._autoFXToolsServerShellViewModel.SearchUsers();
        }
        #endregion
    }
}
