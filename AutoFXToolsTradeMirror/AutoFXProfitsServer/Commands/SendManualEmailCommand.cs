...
{
    public class SendManualEmailCommand : ICommand
    {
        ...
        public SendManualEmailCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            this._autoFXToolsServerShellViewModel.SendManualEmail();
        }
        #endregion
    }
}
