...
{
    public class SortByKeyStringCommand : ICommand
    {
        ...
        public SortByKeyStringCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            _autoFXToolsServerShellViewModel.SortBy("Key String");
        }
        #endregion
    }
}
