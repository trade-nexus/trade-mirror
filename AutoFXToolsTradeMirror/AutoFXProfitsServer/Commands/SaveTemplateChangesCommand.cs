...
{
    public class SaveTemplateChangesCommand : ICommand
    {
        ...
        public SaveTemplateChangesCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            this._autoFXToolsServerShellViewModel.SaveTemplateChanges();
        }
        #endregion
    }
}
