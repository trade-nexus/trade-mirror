    ...
    public class DBHelper
    {
        ...
        public void AddNewUser(string email, string account, string key, string status, string notificationStatus, string alternateEmail)
        {
            try
            {
                ...
                const string query = "INSERT INTO users(`email`,`account_number`,`keystring`,`status`, `created`, `modified`)" +
                                     " VALUES (@email, @account, @key, @status, @created, @modified)";
        ...
        public void EditUser(int id, string email, string account, string key, string status, string notificationStatus, string alternateEmail)
        {
            try
            {
                ...
                const string query = "UPDATE users SET `email`=@email, `account_number`=@account,`keystring`=@key, `status`=@status, `modified`=@modified WHERE `id`=@id";
