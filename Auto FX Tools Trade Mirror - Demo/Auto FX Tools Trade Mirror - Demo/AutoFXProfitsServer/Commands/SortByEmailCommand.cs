...
{
    public class SortByEmailCommand : ICommand
    {
        ...
        public SortByEmailCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            _autoFXToolsServerShellViewModel.SortBy("Email");
        }
        #endregion
    }
}
