...
{
    public class SortByAccountIDCommand : ICommand
    {
        ...
        public SortByAccountIDCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            _autoFXToolsServerShellViewModel.SortBy("Account ID");
        }
        #endregion
    }
}
