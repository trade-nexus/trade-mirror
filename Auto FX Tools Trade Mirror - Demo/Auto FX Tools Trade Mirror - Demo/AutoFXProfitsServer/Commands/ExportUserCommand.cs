...
{
    public class ExportUserCommand : ICommand
    {
        ...
        public ExportUserCommand(AutoFXToolsServerShellViewModel autoFXToolsServerShellViewModel)
        {
        ...
        {
            _autoFXToolsServerShellViewModel.ExportUsers();
        }
        #endregion
    }
}
