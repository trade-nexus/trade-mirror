...
namespace CommunicationLibrary
{
	...
	bool SendToSocket(char *orderInfo)
	{
		...
		ofstream logFile;
		string logPath = path + "\\AutoFX Profits Demo\\logs\\SocketWriterLogs.txt";
	...
	bool SpawnClientTerminal(int hwnd, char* terminalName)
	{
		...
		string logFilePath = path + "\\AutoFX Profits Demo\\logs";

		path = path + "\\AutoFX Profits Demo\\" + terminalName + "\\" + terminalName + ".exe";
